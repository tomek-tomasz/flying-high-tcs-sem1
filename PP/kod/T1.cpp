...
int main(){
    ...
    while(z--){
        ...
        while(!kolejka.empty()){
            ...
            int y = p.getY();
            int nr = p.getNR();
            if(x+1<n && Pom[x+1][y]==0 && (T[x+1][y]==0 || T[x+1][y]==3)){
                if(T[x+1][y]==3){
            ...
            if(x-1>=0 && Pom[x-1][y]==0 && (T[x-1][y]==0 || T[x-1][y]==3)){
                if(T[x-1][y]==3){
                    point w(nr, Pom[x][y]+1, 0);
                    wynik = w;
                    break;
            ...
            if(y+1<m && Pom[x][y+1]==0 && (T[x][y+1]==0 || T[x][y+1]==3)){
                if(T[x][y+1]==3){
                    point w(nr, Pom[x][y]+1, 0);
                    wynik = w;
                    break;
            ...
            if(y-1>=0 && Pom[x][y-1]==0 && (T[x][y-1]==0 || T[x][y-1]==3)){
                if(T[x][y-1]==3){
                    point w(nr, Pom[x][y]+1, 0);
                    wynik = w;
                    break;
